    ...
    <section className="module-cockpit">
      ...
      <div className="module-status-card">
        ...
        <div>
          ...
          <span>Modül menüde tanımlı ve ERP yönlendirmesi hazır. Gerçek veri işlemleri ilgili backend servisi tamamlandığında aktif olacaktır.</span>
        </div>
      </div>
      ...
      <div className="module-action-grid">
        <button onClick={() => navigate("/dashboard")}>
          <AppsIcon />
          <span><b>Panel Özeti</b><small>Ana dashboard'a dön</small></span>
        </button>
        <button onClick={() => navigate("/menu")}>
          <AppsIcon />
          <span><b>Tüm Modüller</b><small>ERP modül kataloğunu aç</small></span>
        </button>
        <button onClick={() => navigate(-1)}>
          <ArrowBackIcon />
          <span><b>Önceki Ekran</b><small>Son ziyaret edilen sayfaya dön</small></span>
        </button>
      </div>
    </section>
  );
