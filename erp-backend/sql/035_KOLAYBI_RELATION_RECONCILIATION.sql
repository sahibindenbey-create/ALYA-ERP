/* 035 - KolayBi operasyonel kayıtları arasındaki ALYA ilişkilerini kurar. Veri silmez. */
SET NOCOUNT ON;SET XACT_ABORT ON;
IF OBJECT_ID(N'dbo.KolaybiBusinessMappings',N'U') IS NULL THROW 53501,N'Önce 033 migrationını çalıştırın.',1;
...
END;
PRINT N'035 KolayBi ilişki uzlaştırma altyapısı tamamlandı.';
GO
